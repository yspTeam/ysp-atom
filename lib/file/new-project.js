...
export default class NewProject {
  ...
  createProject(projectPath) {
    ...
    if (!FileUtils.createFileAndWriteData(configFilePath, this.configText(projectName))) {
  ...
  configText(name) {
    var text = '{"pluginName":"'+name+'","version":"1.0","minYYVersion":"5.9.0","openId":"'+name+'","entryJS":"'+name+'.js","entryClass":"'+name+'","resourceList":{}}';
    return text
  }
