...
export default class NewProject {
  ...
  constructor(serializedState) {
    ...
    this.iOSPackgeNameView.textContent = '请输入iOS包名';
  ...
  projectConfigText(){
    ...
    var text = `{"masterAppUrl":"${url}","iosPackageName":"${iosPackageName}","androidPackageName":"${androidPackageName}","scheme":"${scheme}"}`;
    return text;
  }
