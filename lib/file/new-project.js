...
export default class NewProject {
  ...
  projectConfigText(androidOuputPath){
    ...
    var text = `{"androidAppUrl":"${url1}","iosAppUrl":"${url}","iosBundleId":"${iosPackageName}","androidPackageName":"${androidPackageName}","iosScheme":"${scheme}","androidScheme":"${scheme}","android_output_path":"${androidOuputPath}"}`;
    return text;
  }
