...
export default class NewProject {
  ...
  attach() {
    if (!this.panel) {
      ...
      this.iOSPackageNameEditorView.getModel().setText('com.');
      this.androidPackageNameEditorView.getModel().setText('com.');
      this.schemeEditorView.getModel().setText('');
  ...
  validateInput(projectPath) {
    ...
    console.log(iosPackageName,androidPackageName,scheme);
  ...
  createProject(projectPath) {
    ...
    let androidOuputPath = path.join(resolvedPath, 'build/output/android');
  ...
  projectConfigText(androidOuputPath){
    ...
    var text = `{"masterAppUrl":"${url}","iosBundleId":"${iosPackageName}","androidPackageName":"${androidPackageName}","scheme":"${scheme}","android_output_path":"${androidOuputPath}"}`;
    return text;
  }
