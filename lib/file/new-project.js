...
export default class NewProject {
  ...
  constructor(serializedState) {
    ...
    this.iOSPackageNameEditorView = new TextEditorView({mini:true});
    ...
    this.androidPackageNameEditorView = new TextEditorView({mini:true});
    ...
    this.schemeEditorView = new TextEditorView({mini:true});
...
// console.log(require('./../config-schema').config.iosBundleID);
//       this.iOSPackageNameEditorView.getModel().setText(require('./../config-schema').config.iosBundleID);
//       this.androidPackageNameEditorView.getModel().setText(require('./../config-schema').config.androidPackageName);
//       this.schemeEditorView.getModel().setText(require('./../config-schema').config.scheme);
  ...
  projectConfigText(androidOuputPath){
    ...
    var text = `{"masterAppUrl":"${url}","iosBundleId":"${iosPackageName}","androidPackageName":"${androidPackageName}","iosScheme":"${scheme}","androidScheme":"${scheme}","android_output_path":"${androidOuputPath}"}`;
    return text;
  }
