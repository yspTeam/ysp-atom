...
export default class YSPHttpServer {
    ...
    constructor(serializedState) {
        createZipFolder();
        console.log('ysp http server zip root : ' + zipRootPath);
    }
    ...
    run(callback) {
        ...
        self = this;
        if (httpServerRuning) {
            console.log('ysp http server is running');
            return;
        }
    ...
    stop() {
        ...
        console.log('ysp http server closed');
...
function startServer(port) {
    ...
    this.httpServer.listen(port, () => {
        ...
        console.log('ysp http server success , port:' + getPort());
        complate(getPort());
    });
}
