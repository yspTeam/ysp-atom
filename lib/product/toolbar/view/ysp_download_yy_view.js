...
function loadProjectConfig() {
    ...
    document.getElementById('download_url_ios').getModel().setText(ProjectConfig.masteriOSAppUpdateURL());
    document.getElementById('download_url_android').getModel().setText(ProjectConfig.masterAndroidAppUpdateURL());
    var a = ProjectConfig.androidBuildToolsURL();
    if (a == null) { a = ""; }
    document.getElementById('download_url_android_tools').getModel().setText(a);
