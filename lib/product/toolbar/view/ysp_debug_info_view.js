    ...
    show(htmltag) {
        ...
        <div id='ysp_debug_info_view_bg'>\
             <div style='float:left;widht:49%;'>\
                    <label>iOS Scheme：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_ios_scheme' ></atom-text-editor><br/>\
                    <label>iOS App File Name：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_ios_appfile' ></atom-text-editor><br/>\
                    <label>iOS Bundle Identifier：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_iosid' ></atom-text-editor><br/>\
             </div>\
             <div style='float:left;widht:49%;margin-left:40px'>\
                    <label>Android Scheme：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_android_scheme' ></atom-text-editor><br/>\
                    <label>Android App File Name：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_android_appfile' ></atom-text-editor><br/>\
                    <label>Android package：</label><atom-text-editor class='editor mini' type='text' tabindex='-1' mini='' data-grammar='text plain null-grammar' data-encoding='utf8' id='ysp_setting_androidid' ></atom-text-editor><br/>\
             </div>\
        \
