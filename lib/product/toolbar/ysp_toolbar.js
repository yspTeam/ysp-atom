        ...
        if (this.isShow == true) {
            ...
            for (var i in tags) {
                if (tags[i].className == 'top') {
                    ...
                    document.getElementById("ysp_toolbar_platformname").addEventListener("click", selectplatformBtnClick);
                    document.getElementById("ysp_toolbar_simulator_name").addEventListener("click", simulatorBtnClick);
                    break;
                }
            }

               setPlatformName2Label();
        }
    }
...
function getSimulatorBtn() {
    ...
    <label id='ysp_toolbar_platformname'>YYMoble</label>\
...
function setPlatformName2Label() {
    if (platformArr.length > select_platform) {
        document.getElementById("ysp_toolbar_platformname").innerHTML = platformArr[select_platform];
    }
}
...
function selectplatformBtnClick() {
    console.log('selectplatformBtnClick');
}
